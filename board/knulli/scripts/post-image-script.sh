...
do
    ...
    BATOCERA_POST_IMAGE_SCRIPT="${BR2_EXTERNAL_BATOCERA_PATH}/board/${BATOCERA_PATHSUBTARGET}/create-boot-script.sh"
    bash "${BATOCERA_POST_IMAGE_SCRIPT}" "${HOST_DIR}" "${BR2_EXTERNAL_BATOCERA_PATH}/board/${BATOCERA_PATHSUBTARGET}" "${BUILD_DIR}" "${BINARIES_DIR}" "${TARGET_DIR}" "${BATOCERA_BINARIES_DIR}" || exit 1
    ...
    GENIMAGEDIR="${BR2_EXTERNAL_BATOCERA_PATH}/board/${BATOCERA_PATHSUBTARGET}"
