...
ifeq ($(BR2_PACKAGE_HAS_LIBMALI),y)
    GL_LIB_VARS += GL_LIB="-L$(STAGING_DIR)/usr/lib -lmali" 
endif

define LIBRETRO_PARALLEL_N64_BUILD_CMDS
	$(TARGET_CONFIGURE_OPTS) $(MAKE) CXX="$(TARGET_CXX)" CC="$(TARGET_CC)" $(GL_LIB_VARS) -C $(@D)/ -f Makefile platform="$(LIBRETRO_PARALLEL_N64_PLATFORM)" \
